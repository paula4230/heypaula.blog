...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { album: @playlist.album, artist: @playlist.artist, song_title: @playlist.song_title } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { album: @playlist.album, artist: @playlist.artist, song_title: @playlist.song_title } }
